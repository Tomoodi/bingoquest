...
4. [`supabase/migrations/20260531010000_classes_update_delete.sql`](../supabase/migrations/20260531010000_classes_update_delete.sql) — 先生ダッシュボードのクラス編集・削除のため `classes` に UPDATE/DELETE 権限を追加する
